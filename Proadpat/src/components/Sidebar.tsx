  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-section">
        ...
        <button className="sidebar-nav-item active" onClick={onGoHome}>
        ...
        <button className="sidebar-nav-item" style={{ opacity: 0.5, cursor: 'default' }}>
          ...
          <span style={{ marginLeft: 'auto', fontSize: '0.65rem', color: '#9ca3af', fontWeight: 600 }}>Soon</span>
        </button>
        <button className="sidebar-nav-item" style={{ opacity: 0.5, cursor: 'default' }}>
      ...
      <div className="sidebar-section">
        ...
        <button className="sidebar-nav-item" onClick={onLoadDemo}>
